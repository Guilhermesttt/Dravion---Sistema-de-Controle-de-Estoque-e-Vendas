 ...
 * @property {boolean} [asChild=false] - If true, the button will be rendered as a child of the element, preserving its styles.
 * @extends {React.ButtonHTMLAttributes<HTMLButtonElement> & VariantProps<typeof buttonVariants>}
 */
/**
 * Renders a customizable button component with various styles and sizes.
